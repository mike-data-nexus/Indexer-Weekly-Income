...
export class SetRewardsDestination extends ethereum.Event {
  get params(): SetRewardsDestination__Params {
    return new SetRewardsDestination__Params(this);
  }
}

export class SetRewardsDestination__Params {
  _event: SetRewardsDestination;

  constructor(event: SetRewardsDestination) {
    this._event = event;
  }
...
export class Contract__allocationsResult {
  value0: Address;
  value1: Bytes;
  value2: BigInt;
  value3: BigInt;
  ...
  getCreatedAtEpoch(): BigInt {
    return this.value3;
  }

  getClosedAtEpoch(): BigInt {
    return this.value4;
  }
...
export class Contract__delegationPoolsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
  ...
  getCooldownBlocks(): BigInt {
    return this.value0;
  }

  getIndexingRewardCut(): BigInt {
    return this.value1;
  }

  getQueryFeeCut(): BigInt {
    return this.value2;
  }

  getUpdatedAtBlock(): BigInt {
    return this.value3;
  }
...
export class Contract__getAllocationResultValue0Struct extends ethereum.Tuple {
  get indexer(): Address {
...
export class Contract__getDelegationResultValue0Struct extends ethereum.Tuple {
  get shares(): BigInt {
...
export class Contract__getWithdraweableDelegatedTokensInput_delegationStruct extends ethereum.Tuple {
  get shares(): BigInt {
    return this[0].toBigInt();
  }
...
export class Contract__rebatesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
  ...
  getEffectiveAllocatedStake(): BigInt {
    return this.value1;
  }
  ...
  getUnclaimedAllocationsCount(): BigInt {
    return this.value3;
  }

  getAlphaNumerator(): BigInt {
    return this.value4;
  }

  getAlphaDenominator(): BigInt {
    return this.value5;
  }
}

export class Contract__stakesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
  ...
  getTokensStaked(): BigInt {
    return this.value0;
  }

  getTokensAllocated(): BigInt {
    return this.value1;
  }

  getTokensLocked(): BigInt {
    return this.value2;
  }

  getTokensLockedUntil(): BigInt {
    return this.value3;
  }
}
...
export class Contract extends ethereum.SmartContract {
  ...
  allocations(param0: Address): Contract__allocationsResult {
    ...
    return new Contract__allocationsResult(
      result[0].toAddress(),
      result[1].toBytes(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_allocations(
    param0: Address
  ): ethereum.CallResult<Contract__allocationsResult> {
    ...
    return ethereum.CallResult.fromValue(
      new Contract__allocationsResult(
        value[0].toAddress(),
        value[1].toBytes(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  delegationPools(param0: Address): Contract__delegationPoolsResult {
    let result = super.call(
      "delegationPools",
    ...
    return new Contract__delegationPoolsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_delegationPools(
    param0: Address
  ): ethereum.CallResult<Contract__delegationPoolsResult> {
    let result = super.tryCall(
      "delegationPools",
      "delegationPools(address):(uint32,uint32,uint32,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__delegationPoolsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getAllocation(
  ...
  ): Contract__getAllocationResultValue0Struct {
    let result = super.call(
      "getAllocation",
    ...
    return changetype<Contract__getAllocationResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getAllocation(
    _allocationID: Address
  ): ethereum.CallResult<Contract__getAllocationResultValue0Struct> {
    let result = super.tryCall(
      "getAllocation",
      "getAllocation(address):((address,bytes32,uint256,uint256,uint256,uint256,uint256,uint256))",
      [ethereum.Value.fromAddress(_allocationID)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Contract__getAllocationResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  getDelegation(
    _indexer: Address,
    _delegator: Address
  ): Contract__getDelegationResultValue0Struct {
    let result = super.call(
      "getDelegation",
    ...
    return changetype<Contract__getDelegationResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getDelegation(
    _indexer: Address,
    _delegator: Address
  ): ethereum.CallResult<Contract__getDelegationResultValue0Struct> {
    let result = super.tryCall(
      "getDelegation",
      "getDelegation(address,address):((uint256,uint256,uint256))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Contract__getDelegationResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  getWithdraweableDelegatedTokens(
    _delegation: Contract__getWithdraweableDelegatedTokensInput_delegationStruct
  ): BigInt {
    let result = super.call(
      "getWithdraweableDelegatedTokens",
  ...
  rebates(param0: BigInt): Contract__rebatesResult {
    let result = super.call(
      "rebates",
    ...
    return new Contract__rebatesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebates(param0: BigInt): ethereum.CallResult<Contract__rebatesResult> {
    let result = super.tryCall(
      "rebates",
      "rebates(uint256):(uint256,uint256,uint256,uint32,uint32,uint32)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  rewardsDestination(param0: Address): Address {
    let result = super.call(
      "rewardsDestination",
      "rewardsDestination(address):(address)",
      [ethereum.Value.fromAddress(param0)]
    );
  ...
  try_rewardsDestination(param0: Address): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "rewardsDestination",
      "rewardsDestination(address):(address)",
      [ethereum.Value.fromAddress(param0)]
  ...
  stakes(param0: Address): Contract__stakesResult {
    let result = super.call(
      "stakes",
    ...
    return new Contract__stakesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_stakes(param0: Address): ethereum.CallResult<Contract__stakesResult> {
    let result = super.tryCall(
      "stakes",
      "stakes(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
...
export class SetRewardsDestinationCall extends ethereum.Call {
  get inputs(): SetRewardsDestinationCall__Inputs {
    return new SetRewardsDestinationCall__Inputs(this);
  }

  get outputs(): SetRewardsDestinationCall__Outputs {
    return new SetRewardsDestinationCall__Outputs(this);
  }
}

export class SetRewardsDestinationCall__Inputs {
  _call: SetRewardsDestinationCall;

  constructor(call: SetRewardsDestinationCall) {
    this._call = call;
  }
...
export class SetRewardsDestinationCall__Outputs {
  _call: SetRewardsDestinationCall;
